...
SECRET_KEY = 'django-insecure-28g^^1e$25gwj$4f$haq=0dr4ausi4syq&vr#aw9_fkjql$gpu'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'back', 'templates', 'taller'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': '00',  # Contraseña
        'HOST': 'localhost',  # Host o dirección IP del servidor
